...
import reducer, { requestData,filterTopN, filterAboveValue, filterAverage, reset } from "../../../src/features/Data/DataSlice";
...
describe("DataSlice" ,() => {
    ...
    it("Dataset selezionato e caricato con successo" ,()=> {
        ...
        return store.dispatch(requestData(1)).then(() => {
            ...
            expect(reducer(initialState,{type: requestData.fulfilled.type, payload:mockDataset})).toEqual(expectedState);
        });
    });
    ...
    it("Dataset selezionato e caricato con insuccesso" ,()=> {
        ...
        return store.dispatch(requestData(1)).then(() => {
            ...
            expect(reducer(initialState,{type: requestData.rejected.type})).toEqual(initialState);
        });
    ...
    it("Filtraggio dei top 2 valori" ,()=> {
        const initialState: DataState = {
            data: [{ id: 0, show:true, x: 0, y: 1, z: 0 },{ id: 1, show:true, x: 0, y: 2, z: 0 },{ id: 2, show:true, x: 0, y: 3, z: 0 },{ id: 3, show:true, x: 0, y: 4, z: 0 }],
            legend: { x: "X", y: "Y", z: "Z" },
            average: 2.5,
            z: ["Label 1"],
            x: ["Label 1"],
        ...
        const expectedState: DataState = {
            data: [{ id: 0, show:false, x: 0, y: 1, z: 0 },{ id: 1, show:false, x: 0, y: 2, z: 0 },{ id: 2, show:true, x: 0, y: 3, z: 0 },{ id: 3, show:true, x: 0, y: 4, z: 0 }],
            legend: { x: "X", y: "Y", z: "Z" },
            average: 2.5,
            z: ["Label 1"],
            x: ["Label 1"],
        }; 
        expect(reducer(initialState,filterTopN({value: 2,isGreater:true}))).toEqual(expectedState);
    ...
    it("Filtraggio dei bottom 2 valori" ,()=> {
        ...
        const expectedState: DataState = {
            data: [{ id: 0, show:true, x: 0, y: 1, z: 0 },{ id: 1, show:true, x: 0, y: 2, z: 0 },{ id: 2, show:false, x: 0, y: 3, z: 0 },{ id: 3, show:false, x: 0, y: 4, z: 0 }],
            legend: { x: "X", y: "Y", z: "Z" },
            average: 2.5,
            z: ["Label 1"],
            x: ["Label 1"],
        }; 
        expect(reducer(initialState,filterTopN({value: 2,isGreater:false}))).toEqual(expectedState);
    ...
    it("Filtraggio dei valori superiori o uguali a 3" ,()=> {
        ...
        expect(reducer(initialState,filterAboveValue({value: 3,isGreater:true}))).toEqual(expectedState);
    });
    ...
    it("Filtraggio dei valori inferiori o uguali a 3" ,()=> {
        ...
        const expectedState: DataState = {
            data: [{ id: 0, show:true, x: 0, y: 1, z: 0 },{ id: 1, show:true, x: 0, y: 2, z: 0 },{ id: 2, show:true, x: 0, y: 3, z: 0 },{ id: 3, show:false, x: 0, y: 4, z: 0 }],
            legend: { x: "X", y: "Y", z: "Z" },
            average: 2.5,
            z: ["Label 1"],
            x: ["Label 1"],
        }; 
        expect(reducer(initialState,filterAboveValue({value: 3,isGreater:false}))).toEqual(expectedState);
