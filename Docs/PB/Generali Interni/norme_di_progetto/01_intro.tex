\section{Introduzione}
    ...
    \subsection{Riferimenti}
        ...
        \begin{itemize}
            ...
            \item Riferimento per alcune metriche di processo: \\ \url{https://it.wikipedia.org/wiki/Metriche_di_progetto} \\ Ultimo accesso: \textit{16-12-2024}
            \item Indice Gulpease: \\ \url{https://it.wikipedia.org/wiki/Indice_Gulpease} \\ Ultimo accesso: \textit{16-12-2024}
            \item Requirements Stability Index (RSI): \\ \url{https://shiyamtj.wordpress.com/2018/09/26/requirement-stability-index/} \\ Ultimo accesso: \textit{16-12-2024}
