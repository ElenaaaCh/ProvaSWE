...
\begin{itemize}
      ...
      \item \textit{\textbf{Specifica tecnica}}: documento che descrive in dettaglio l'architettura del sistema, le tecnologie utilizzate e le scelte progettuali adottate.\\
            ...
            \begin{itemize}
                  \item \textbf{Introduzione}: riporta lo scopo del documento, lo scopo del prodotto, i riferimenti normativi e informativi;
                  \item \textbf{Tecnologie}: descrive i linguaggi di programmazione, i framework e gli strumenti di supporto utilizzati per lo sviluppo del prodotto. Viene fornita una breve descrizione di ciascuna tecnologia, evidenziando le motivazioni che hanno portato alla loro scelta;
      ...
      \item \textit{\textbf{Manuale utente}}: documento che fornisce istruzioni dettagliate su come utilizzare il prodotto software. Include istruzioni su come accedere al sistema, configurarlo e utilizzarlo.\\
      Il corpo del documento è composto dalle seguenti sezioni:
            \begin{itemize}
                  ...
                  \item \textbf{Panoramica del sito}: descrive le schermate iniziali del sito, dove l’utente può selezionare un dataset e visualizzarne i dettagli prima di accedere all’ambiente 3D interattivo;
