...
\begin{itemize}
      ...
      \item \textit{\textbf{Manuale utente}}: documento che fornisce istruzioni dettagliate su come utilizzare il prodotto software. Include istruzioni su come accedere al sistema, configurarlo e utilizzarlo. Rappresenta una guida testuale pensata per permettere all’utente di usufruire in maniera efficace e completa di tutte le funzionalità offerte dal software\\
