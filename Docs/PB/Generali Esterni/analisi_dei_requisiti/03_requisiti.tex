...
\requirementsTable{
    ...
    \RQM & Il software deve essere testato attraverso test di tipo e2e, concentrando l'attenzione sulle funzionalità chiave che impattano sull'esperienza utente (almeno 3 funzionalità) & Desiderabile  & Capitolato \tabularnewline 
...
\requirementsTable{
    ...
    \RVM & Il software deve supportare un massimo di 500 elementi per le coordinate X e Z mantenendo il limite di 5000 dati (es. con 500 righe, il massimo numero di colonne sarà pari a 10) & Obbligatorio & Decisione interna \tabularnewline
...
\requirementsTable{
    \RPM & Il software quando carica un dataset di dimensioni minori o uguali a 2000 non deve avere un tempo di caricamento superiore a 1 secondo  & Obbligatorio & Decisione interna \tabularnewline
    \RPM & Il software quando carica un dataset di dimensioni minori o uguali a 2000 non deve avere un tempo di rendering superiore a 1 secondo  & Obbligatorio & Decisione interna \tabularnewline
    \RPM & Il software quando carica un dataset di dimensioni minori o uguali a 3500 non deve avere un tempo di caricamento superiore a 2 secondi  & Obbligatorio & Decisione interna \tabularnewline
    \RPM & Il software quando carica un dataset di dimensioni minori o uguali a 3500 non deve avere un tempo di rendering superiore a 1 secondo & Obbligatorio & Decisione interna \tabularnewline
    \RPM & Il software quando carica un dataset di dimensioni minori o uguali a 5000 non deve avere un tempo di caricamento superiore a 3 secondi  & Obbligatorio & Decisione interna \tabularnewline
    \RPM & Il software quando carica un dataset di dimensioni minori o uguali a 5000 non deve avere un tempo di rendering superiore a 1 secondo  & Obbligatorio & Decisione interna \tabularnewline
